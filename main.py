...
TRANSLATIONS = {
    ...
    "🇬🇧 English": {
        ...
        "search": "🔍 Search...", "total_leads": "Leads: {n}", "click_info": "💡 Check box to open.",
...
def load_options():
    opts = {
        ...
        "titles": ["CEO", "Ejer", "Manager"], "kilde": ["Inbound", "AI Scan"], "sprog": ["Dansk", "Engelsk", "Spansk", "Svensk"]
    }
    if db_engine:
        try:
...
def lead_popup(idx):
    ...
    with t2:
        ...
        with c1:
            ...
            upd['Area'] = c1.selectbox("Område", ["Costa del Sol Vest", "Costa del Sol Midt", "Costa del Sol Øst", "Costa Blanca", "Inland"], index=0)
        ...
        with c2:
            cur_ind = sorted(list(INDUSTRIES.keys()))
...
# TABELVISNING (AUTO-OPEN VED KLIK I VENSTRE SIDE)
