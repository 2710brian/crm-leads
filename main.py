...
# --- 2. SPROG-DATABASE (KOMPLET 35+ FELTER) ---
TRANSLATIONS = {
    "🇩🇰 Dansk": {
    ...
    "🇬🇧 English": {
        ...
        "tab1": "📞 Contact & Social", "tab2": "🌍 Geo", "tab3": "⚙️ Sales", "tab4": "📝 Desc", "tab5": "📁 Media",
        ...
        "f_br": "Industry", "f_ubr": "Sub-industry", "f_lang": "Languages", "f_work": "Hours", 
...
GEOGRAPHY = {
    ...
    "Murcia": ["Murcia", "Cartagena"], "Balearic Islands": ["Palma de Mallorca", "Ibiza"]
}
INDUSTRIES = {
...
# --- 8. KLIENT KORT POPUP (ALT ER MED) ---
...
if 'sel_rows' in st.session_state and len(st.session_state.sel_rows) > 0:
    ...
    if len(st.session_state.sel_rows) == 1:
        if c_btn1.button("✏️ REDIGER KLIENT", type="primary", use_container_width=True):
